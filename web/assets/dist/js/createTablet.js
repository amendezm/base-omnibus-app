$(document).ready(function(){
    $('#tablet_fechaPublicacion').datetimepicker({
        format:'YYYY-MM-DD HH:mm',
        locale:'es'
    });

    $('#tablet_fechaExpiracion').datetimepicker({
        format:'YYYY-MM-DD HH:mm',
        locale:'es',
        useCurrent: false //Important! See issue #1075
    });

    $("#tablet_fechaPublicacion").on("dp.change", function (e) {
        $('#tablet_fechaExpiracion').data("DateTimePicker").minDate(e.date);
    });
...
var $addProductLink = $('<a class="link-black text-sm" href="#"><i class="fa fa-plus-circle margin-r-5 text-green"></i> Adicionar plato</a>');
