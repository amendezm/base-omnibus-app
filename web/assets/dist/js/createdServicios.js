...
var $addProductLink = $('<a class="link-black text-sm" href="#"><i class="fa fa-plus-circle margin-r-5 text-green"></i> Adicionar Comensal</a>');
...
function addTagFormDeleteLink($addComponetRow) {
    var $removeFormA = $('<button  title="Eliminar solicitud" data-toggle="tooltip" class="btn btn-box-tool" type="button"> <i class="fa fa-trash text-red"></i> Eliminar</button>' );
