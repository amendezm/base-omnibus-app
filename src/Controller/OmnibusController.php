...
class OmnibusController extends AbstractController
{
    ...
    public function indexAction()
    {
        ...
        $omnibuses = $em->getRepository('App:Omnibus')->findAll();

        return $this->render('omnibus/index.html.twig', array(
            'omnibuses' => $omnibuses,
        ));
    }
    public function combustibleHabilitadoAction(Connection $connection)
    {
        $db = $connection;
        $query = 'SELECT
           omnibus.noomnibus,
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $reportes = $em->getRepository('App:Omnibus')->findAll(Query::HYDRATE_ARRAY);
    ...
    public function Plan_combustibleAction(Connection $connection)
    {
        $db = $connection;
        $query = 'SELECT
           ruta.noruta,
    ...
    public function reporteporOmnibusAction(Connection $connection)
    {
        $em = $this->getDoctrine()->getManager();
        $db = $connection;
        $query = 'SELECT
    ...
    {
        $omnibus = new Omnibus();
        $form = $this->createForm('App\Form\OmnibusType', $omnibus);
    ...
    {
        $editForm = $this->createForm('App\Form\OmnibusType', $omnibus);
