...
use App\Entity\Tipo_omnibus;
use App\Form\Tipo_omnibusType;
 ...
 *
 */
class Tipo_omnibusController extends AbstractController
{
    /**
    ...
    public function indexAction()
    {
        ...
        $tipo_omnibuses = $em->getRepository('App:Tipo_omnibus')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('App\Form\Tipo_omnibusType', $tipo_omnibus);
    ...
    {
        $editForm = $this->createForm('App\Form\Tipo_omnibusType', $tipo_omnibus);
