...
class TipoCombustible
{
   ...
   */
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Tarjeta_combustible", mappedBy="combustibleTipo")
     */
     ...
     *
     * @param \AppBundle\Entity\Tarjeta_combustible $tarjetaCombustible
     *
     * @return TipoCombustible
     */
    public function addTarjetaCombustible(\AppBundle\Entity\Tarjeta_combustible $tarjetaCombustible)
    {
     ...
     * @param \AppBundle\Entity\Tarjeta_combustible $tarjetaCombustible
     */
    public function removeTarjetaCombustible(\AppBundle\Entity\Tarjeta_combustible $tarjetaCombustible)
    {
