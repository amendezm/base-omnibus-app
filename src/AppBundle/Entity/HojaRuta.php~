...
class HojaRuta
{
    ...
    private $fecha;
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Turno", inversedBy="hojaRute")
     * @ORM\JoinColumn(name="id_turno", referencedColumnName="id", onDelete="CASCADE")
     */
    protected $turno;
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Omnibus", inversedBy="hojaRute")
     * @ORM\JoinColumn(name="id_omnibus", referencedColumnName="id", onDelete="CASCADE")
     */
    protected $omnibus;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Recaudacion", mappedBy="hojaRute")
     */
    protected $recaudaciones;

    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Ruta", inversedBy="hojaRute")
     * @ORM\JoinColumn(name="id_ruta", referencedColumnName="id", onDelete="CASCADE")
     */
    protected $ruta;

//    /**
//     * @orm\Manytoone(targetEntity="AppBundle\Entity\Incidencia", inversedBy="hojaRuta")
//     * @orm\Joincolumn(name="id_incidencia", referencedColumnName="idincidencia")
//     */
//    protected $incidenciahr;

    /**
     * @orm\OneToMany(targetEntity="AppBundle\Entity\Incidencias_HR", mappedBy="hojaRuta")
     */
...
//        $this->incidencia_hr = new \Doctrine\Common\Collections\ArrayCollection();
     ...
     * Add recaudacione
     *
     * @param \AppBundle\Entity\Recaudacion $recaudacione
     *
     * @return HojaRuta
     */
