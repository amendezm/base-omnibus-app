 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\EscogidaTurnoRepository")
 */
class EscogidaTurno
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Ruta", inversedBy="escogida")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Chofer", inversedBy="escogida")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Omnibus", inversedBy="escogida")
