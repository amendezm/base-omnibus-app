...
class Trabajador
{
    ...
    private $id;
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Chofer", mappedBy="trabajador", cascade="remove")
     */
    protected $chofer;
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Usuario", mappedBy="trabajador")
     */
    protected $user;
     ...
     * @return Trabajador
     */
    public function addUser(\App\Entity\Usuario $user)
    {
        $this->user[] = $user;
     ...
     * @param \App\Entity\Usuario $user
     */
    public function removeUser(\App\Entity\Usuario $user)
    {
