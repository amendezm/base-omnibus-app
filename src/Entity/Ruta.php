...
class Ruta
{
    ...
    /**
     * @orm\Onetomany(targetEntity="App\Entity\HojaRuta", mappedBy="ruta")
     */
    protected $hojaruta;
    /**
     * @orm\Onetomany(targetEntity="App\Entity\EscogidaTurno", mappedBy="ruta")
     */
    protected $escogida;

    /**
     * @orm\Onetomany(targetEntity="App\Entity\DiasSemana", mappedBy="ruta")
     */
    protected $dias;
    ...
    /**
     * @orm\Manytoone(targetEntity="App\Entity\Servicio", inversedBy="ruta")
     ...
     * add dia
     *
     * @param \App\Entity\DiasSemana $dia
     *
     * @return ruta
     */
    public function addDia(\App\Entity\DiasSemana $dia)
    {
        $this->dias[] = $dia;
     ...
     * @param \App\Entity\DiasSemana $dia
     */
    public function removeDia(\App\Entity\DiasSemana $dia)
    {
     ...
     * @return ruta
     */
    public function addServicio(\App\Entity\Servicio $servicio)
    {
     ...
     * @param \App\Entity\Servicio $servicio
     */
    public function removeServicio(\App\Entity\Servicio $servicio)
    {
