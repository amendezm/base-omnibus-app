...
//    /**
//     * @orm\OneToMany(targetEntity="App\Entity\HojaRuta", mappedBy="incidenciahr")
//     */
//    protected $hojaRuta;

    /**
     * @orm\Manytoone(targetEntity="App\Entity\TipoIncidencia", inversedBy="incidencia")
     * @orm\Joincolumn(name="id_tipo", referencedColumnName="id")
     */
    protected $tipoIncidencia;

    /**
     * @orm\OneToMany(targetEntity="App\Entity\Incidencias_HR", mappedBy="incidencias")
     */
     ...
     * Add incidencia_hr
     *
     * @param \App\Entity\Incidencias_HR $incidencia_hr
     *
     * @return Incidencias_HR
     */
    public function addIncidencias_HR(\App\Entity\Incidencias_HR $incidencia_hr)
    {
     ...
     * @param \App\Entity\Incidencias_HR $incidencia_hr
     */
    public function removeIncidencias_HR (\App\Entity\Incidencias_HR $incidencia_hr)
    {
