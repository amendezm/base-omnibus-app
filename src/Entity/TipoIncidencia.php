...
class TipoIncidencia
{
    ...
    /**
     * @orm\OneToMany(targetEntity="App\Entity\Incidencia", mappedBy="tipoIncidencia")
     */
     ...
     * Add incidencium
     *
     * @param \App\Entity\Incidencia $incidencium
     *
     * @return TipoIncidencia
     */
    public function addIncidencium(\App\Entity\Incidencia $incidencium)
    {
     ...
     * @param \App\Entity\Incidencia $incidencium
     */
    public function removeIncidencium(\App\Entity\Incidencia $incidencium)
    {
