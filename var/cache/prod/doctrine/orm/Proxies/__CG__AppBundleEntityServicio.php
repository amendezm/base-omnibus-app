 ...
 */
class Servicio extends \AppBundle\Entity\Servicio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Servicio' . "\0" . 'id', 'ruta', '' . "\0" . 'AppBundle\\Entity\\Servicio' . "\0" . 'tipo');
        }
