 ...
 */
class base extends \AppBundle\Entity\base implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\base' . "\0" . 'id', 'omnibus', '' . "\0" . 'AppBundle\\Entity\\base' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\base' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\base' . "\0" . 'direccion');
        }
