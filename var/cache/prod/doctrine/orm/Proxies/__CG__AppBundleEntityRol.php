...
class Rol extends \AppBundle\Entity\Rol implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Rol' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Rol' . "\0" . 'role', '' . "\0" . 'AppBundle\\Entity\\Rol' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Rol' . "\0" . 'usuarios');
        }
