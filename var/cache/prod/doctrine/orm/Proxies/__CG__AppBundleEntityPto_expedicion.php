 ...
 */
class Pto_expedicion extends \AppBundle\Entity\Pto_expedicion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pto_expedicion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Pto_expedicion' . "\0" . 'nombre', 'ruta', '' . "\0" . 'AppBundle\\Entity\\Pto_expedicion' . "\0" . 'ubicacion', '' . "\0" . 'AppBundle\\Entity\\Pto_expedicion' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pto_expedicion $proxy) {
