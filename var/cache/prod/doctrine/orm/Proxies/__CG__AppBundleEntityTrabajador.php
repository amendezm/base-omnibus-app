 ...
 */
class Trabajador extends \AppBundle\Entity\Trabajador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Trabajador' . "\0" . 'id', 'chofer', 'user', '' . "\0" . 'AppBundle\\Entity\\Trabajador' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Trabajador' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Trabajador' . "\0" . 'ci', '' . "\0" . 'AppBundle\\Entity\\Trabajador' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\Trabajador' . "\0" . 'cargo');
        }
